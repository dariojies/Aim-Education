...
export default function App() {
  ...
  if (pathname === '/' || pathname === '') {
    ...
    const adminSub = { campamento: 'camp', alumnos: 'students', clases: 'classes', eventos: 'events', noticias: 'news', gastos: 'payments', recibos: 'payments', facturacion: 'billing', soporte: 'support', reportes: 'reportes' }[seg[1]] || 'overview';
